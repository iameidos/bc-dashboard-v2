        ...
        <div className="w-full xl:w-1/3 space-y-6">
          ...
          <div className="bg-primary-foreground p-4 rounded-lg space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel voluptas distinctio ab ipsa commodi fugiat labore quos veritatis cum corrupti sed repudiandae ipsum,
              harum recusandae ratione ipsam in, quis quia.
            </p>
          </div>
          ...
          <div className="bg-primary-foreground p-4 rounded-lg">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Indonesia, West Java 16750</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-bold">City:</span>
                <span>Kabupaten Bogor, KM. 72</span>
              </div>
            </div>
            <p className="text-sm text-muted-foreground mt-4">Joined on Monday, July 28 2025</p>
          </div>
        </div>
        {/* RIGHT */}
