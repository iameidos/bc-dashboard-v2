...
const categories = ['T-shirts', 'Shoes', 'Accessories', 'Bags', 'Dresses', 'Jackets', 'Gloves'] as const;
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Product short description.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Enter the category of product.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Select the available sizes of the product.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Select the available colors of the product.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
